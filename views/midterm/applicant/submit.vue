              ...
              <a-col :xs="24" :md="12">
                ...
                >
                  <a-select
                    ...
                    size="large"
                  >
                    <a-select-option value="regular">常规中期</a-select-option>
                    <a-select-option value="special">专项中期</a-select-option>
                    <a-select-option value="extended">延期中期</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
            </a-row>
...
// import MaterialTemplateSync from '@/components/MaterialTemplateSync.vue' // 临时注释
...
const handleSubmit = async (values) => {
  try {
    ...
    router.push('/th_qd/midterm/applicant/manage')
