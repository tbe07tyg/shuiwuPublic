...
const applications = ref([
  {
    ...
    materials: [
      { id: 1, name: '项目中期报告.pdf', type: '中期报告' },
    ...
    rejectionInfo: {
      time: '2024-01-18',
      reviewer: '张审核员',
      comments: '材料基本符合要求，但需要完善部分内容。请提供详细的项目实施计划和时间节点。',
      rejectionReason: '1. 项目中期报告中缺少详细的研究目标和技术路线；2. 技术方案需要补充风险分析和应对措施。请提供详细的项目实施计划和时间节点。'
    }
  },
  {
    id: 2,
    ...
    materials: [
      { id: 3, name: '项目中期报告.pdf', type: '中期报告' }
    ]
  },
  {
    id: 3,
    ...
    materials: [
      { id: 4, name: '项目中期报告.pdf', type: '中期报告' },
      { id: 5, name: '技术框架.pdf', type: '技术文档' }
    ],
    meetingInfo: {
  ...
  },
  {
    ...
    materials: [
      { id: 6, name: '项目中期报告.pdf', type: '中期报告' }
    ],
    conclusion: {
      time: '2024-01-25',
      type: 'midterm_passed',
      feedback: '项目技术方案可行，预期目标明确，研究计划合理，专家组一致通过中期申请。建议在实施过程中加强用户体验设计和数据安全保护。',
      score: 92
    }
  },
  {
    ...
    status: 'midterm_conditional',
    submitTime: '2024-01-25',
    expectedTime: '2024-03-25',
    description: '5G基站布局优化算法研究',
    materials: [
      { id: 7, name: '项目中期报告.pdf', type: '中期报告' }
    ],
    conclusion: {
      time: '2024-02-10',
      type: 'midterm_conditional',
      feedback: '项目研究方向正确，但技术路线需进一步完善。要求在3个月内补充详细的算法设计和实验方案，并重新提交审核。',
      requirements: '1. 补充算法的理论分析和性能评估指标。提供详细的实验环境搭建方案；3. 完善项目风险评估和应对措施。'
    }
  },
  {
    id: 6,
    ...
    status: 'midterm_failed',
    submitTime: '2024-02-05',
    expectedTime: '2024-04-05',
    description: '基于区块链的安全电子投票平台',
    materials: [
      { id: 8, name: '项目中期报告.pdf', type: '中期报告' }
    ],
    conclusion: {
      time: '2024-02-20',
      type: 'midterm_failed',
      feedback: '项目技术方案存在重大安全隐患，研究目标与现有资源不匹配，专家组认为项目不具备实施条件，不予通过中期申请。建议重新设计技术方案后重新申请。',
      requirements: '1. 重新设计技术方案后重新申请。'
    }
  }
])
...
const getMoreActions = (record) => {
  ...
  if (['midterm_passed', 'midterm_conditional', 'midterm_failed'].includes(record.status)) {
...
const goToSubmit = () => {
  router.push('/th_qd/midterm/applicant/submit')
}
